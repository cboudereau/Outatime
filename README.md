...
### Applicative functor way
In order to hide temporality function call and pipelining, here is the applicative functor which sort apply and defaultToNone automatically.
